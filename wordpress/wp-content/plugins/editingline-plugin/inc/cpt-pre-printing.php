<?php
function register_pre_printing_cpt() {
    // Register Custom Post Type Pre Printing
    $labels = array(
        'name'                  => _x('Pre Printings', 'Post Type General Name', 'text_domain'),
        'singular_name'         => _x('Pre Printing', 'Post Type Singular Name', 'text_domain'),
        'menu_name'             => __('Pre Stampa', 'text_domain'),
        'name_admin_bar'        => __('Pre Printing', 'text_domain'),
    ...
    $args = array(
        'label'                 => __('Pre Printing', 'text_domain'),
        'description'           => __('Custom Post Type for Pre Printing', 'text_domain'),
        'labels'                => $labels,
    ...
    register_post_type('pre-printing', $args);
    ...
    register_taxonomy('pre-printing-typology', array('pre-printing'), $args);
}

add_action('init', 'register_pre_printing_cpt');

add_action('init', 'ensure_brand_taxonomy_for_cpts', 11); // Ensure this runs after CPTs and taxonomies are registered