<?php
function register_digital_print_cpt() {
    // Register Custom Post Type Digital Print
    $labels = array(
        'name'                  => _x('Digital Prints', 'Post Type General Name', 'text_domain'),
        'singular_name'         => _x('Digital Print', 'Post Type Singular Name', 'text_domain'),
        'menu_name'             => __('Stampa Digitale', 'text_domain'),
        'name_admin_bar'        => __('Digital Print', 'text_domain'),
    ...
    $args = array(
        'label'                 => __('Digital Print', 'text_domain'),
        'description'           => __('Custom Post Type for Digital Prints', 'text_domain'),
        'labels'                => $labels,
        ...
        'show_in_rest'          => true, // This line is crucial for Gutenberg to work
    );
    register_post_type('digital-print', $args);
}
...
function register_digital_print_typology_taxonomy() {
    ...
    $args = array(
        ...
        'show_in_nav_menus'          => true,
        'show_tagcloud'              => true,
        'show_in_rest'               => true, // Enable Gutenberg editor for taxonomy
    );
    register_taxonomy('digital-print-typology', array('digital-print'), $args);
}



add_action('init', 'register_digital_print_cpt');
add_action('init', 'register_digital_print_typology_taxonomy');
add_action('init', 'register_digital_print_size_taxonomy');
